...
var ReplicaHealthStatus_name = map[int32]string{
	0: "Unspecified",
	1: "Healthy",
	2: "NotHealthy",
}

var ReplicaHealthStatus_value = map[string]int32{
	"Unspecified": 0,
	"Healthy":     1,
	"NotHealthy":  2,
}
...
func (ReplicaHealthStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_df4c2c740e1454e5, []int{5}
}
...
func (m *ReplicaStatus) GetHealthStatus() ReplicaHealthStatus {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("api.common.v1.ReplicaHealthStatus", ReplicaHealthStatus_name, ReplicaHealthStatus_value)
...
var fileDescriptor_df4c2c740e1454e5 = []byte{
	...
	,
}
...
func (x ReplicaHealthStatus) String() string {
	s, ok := ReplicaHealthStatus_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (m *ReplicaStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.HealthStatus != 0 {
		i = encodeVarintMessage(dAtA, i, uint64(m.HealthStatus))
		i--
		dAtA[i] = 0x38
	}
	if m.Mode != 0 {
...
func (m *ReplicaStatus) Size() (n int) {
	...
	if m.HealthStatus != 0 {
		n += 1 + sovMessage(uint64(m.HealthStatus))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HealthStatus |= ReplicaHealthStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}

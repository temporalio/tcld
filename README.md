...
```
tcld group get <group-id>
```

### Set group access:
```
tcld group set-access -id <group-id> --account-role read --namespace-role <namespace>-read
```
